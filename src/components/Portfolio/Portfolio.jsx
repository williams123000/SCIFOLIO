  ...
  return (
    <div className="Portfolio d-block d-lg-block col-12 col-lg-10">
      <div className="Menu-Portfolio d-none d-lg-flex p-2 w-50 justify-content-around">
        <Button className='d-flex align-items-center gap-3 justify-content-center' variant="dark" onClick={() => changeStep("About")} style={{ color: step == "About" ? "#D4BA70" : "#ECECEC" }}>Acerca de</Button>
        <Button className='d-flex align-items-center gap-3 justify-content-center' variant="dark" onClick={() => changeStep("Resume")} style={{ color: step == "Resume" ? "#D4BA70" : "#ECECEC" }}>Resumen</Button>
        <Button className='d-flex align-items-center gap-3 justify-content-center' variant="dark" onClick={() => changeStep("Portfolio")} style={{ color: step == "Portfolio" ? "#D4BA70" : "#ECECEC" }}>Portafolio</Button>
        ...
        <Button className='d-flex align-items-center gap-3 justify-content-center' variant="dark" onClick={() => changeStep("Contact")} style={{ color: step == "Contact" ? "#D4BA70" : "#ECECEC" }}>Contacto</Button>
      </div>
